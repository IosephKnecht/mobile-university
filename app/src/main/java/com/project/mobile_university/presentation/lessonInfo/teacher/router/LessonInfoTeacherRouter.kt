package com.project.mobile_university.presentation.lessonInfo.teacher.router
...
class LessonInfoTeacherRouter : AbstractRouter<LessonInfoTeacherContract.RouterListener>(),
    LessonInfoTeacherContract.Router {
